    ...
    public void run() {
        ...
        while(true){
            try {
                ...
                for(ServerHeartBeatInfo info : _server_model.getALiveServerListToSendToClient(true)){
                    System.out.println(info);
                }

                //send this list to the Client
                sendUdpMessage(
                        new Message(Message.TYPE_OF_MESSAGE.ALIVE_SERVER_LIST, _server_model.getALiveServerListToSendToClient(true)),
